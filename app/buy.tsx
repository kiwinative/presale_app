...
function Buy() {
  ...
  return (
    <><div className={`flex flex-row gap-[25px] sm:gap-[150px] md:gap-[250px] ${open && "md:gap-[100px]"} mt-[30px]`}>
          ...
          <div className={`flex flex-col gap-10 md:flex-row  items-center justify-evenly px-[30px] ${open && "md:flex-col gap-[60px]"} ${open && "lg:flex-row px-[150px]"} lg:px-[87px] py-[73px] w-full bg-[#140E3A] rounded-[27px]`}>
